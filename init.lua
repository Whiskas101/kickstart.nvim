...
require('lazy').setup({
  ...
  -- Oil for managing the creation and deletion of files
  {
    ...
    columns = {
      'icon', -- shows file icon
      'size', -- file size
      'mtime', -- last modified time
      'permissions', -- file permissions
      'git_status', -- git info (requires `git_status` adapter)
    },
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- Update this to reflect how typical cursor movement is in neovim
          ...
          -- CR is Carriage return, or simply the Enter key
